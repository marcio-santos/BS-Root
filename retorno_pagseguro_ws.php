<?php
    ...
    $retorno_token = 'E61B2A21174E465AB0AA2925623E4C38'; // Token gerado pelo PagSeguro BodySystems
    /*
    Treinamento
    ...
    */
    ...
    try {
        ...
        if ($confirma) {
            ...
            $ValorFrete = $volta[3]; //$_POST['ValorFrete'];
            $Extras = $_POST['Extras'];
            ...
            file_put_contents('pagseguro_query.log',$query) ;
